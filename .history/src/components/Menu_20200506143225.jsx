...
const resetGame = (props) =>{
    return (
        <button onClick={() => props.reset && props.reset()} className="button-items">
            <span className="menu-icon"><FaRecycle className="reset-icon"/></span> Redefinir partida
        </button>
    )
}
...
const playerCPU = (props) =>{
    return (
        <button className="button-items" onClick={()=> props.twoPlayer && props.twoPlayer()}>
            <span className="menu-icon"><FaMicrochip className="cpu-icon"/></span> Jogador X CPU
        </button>
    )
}
...
const playerPlayer = (props) =>{
    return (
        <button className="button-items" onClick={()=> props.onePlayer && props.onePlayer()}>
            <span className="menu-icon"><FaUserFriends className="user-icon"/></span> Dois jogadores
        </button>
    )
}
    ...
    return (
        <button className="button-items dark">
            <div className="flex-center">
                <span className="menu-icon"><FaAdjust className="dark-icon"/></span> Modo escuro
            </div>
            <div className="flex-center">
